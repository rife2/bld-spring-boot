...
public class DemoApplicationBuild extends WebProject {
    public DemoApplicationBuild() {
        ...
        scope(compile)
                .include(dependency("org.springframework.boot:spring-boot-starter:3.2.1"))
                .include(dependency("org.springframework.boot:spring-boot-starter-actuator:3.2.1"))
                .include(dependency("org.springframework.boot:spring-boot-starter-web:3.2.1"));
        scope(test)
                .include(dependency("org.springframework.boot:spring-boot-starter-test:3.2.1"))
        ...
        scope(standalone)
                .include(dependency("org.springframework.boot:spring-boot-loader:3.2.1"));
    }
